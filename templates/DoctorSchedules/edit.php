...
.btn-danger { background: transparent; border: 1px solid #dc3545; color: #dc3545; padding: 12px 24px; border-radius: 8px; text-decoration: none; }
...
<div class="form-container" style="max-width: 800px; margin: 0 auto; padding: 40px 20px;">
    <div class="page-header" style="margin-bottom: 30px; display: flex; justify-content: space-between; align-items: center;">
        <h1 class="page-title" style="font-size: 28px; font-weight: 700; color: #1f1f1f;">
            <i class="fas fa-edit" style="color: #0066cc; margin-right: 10px;"></i>
    ...
    <div class="form-card">
        ...
        <div class="form-group" style="margin-top: 10px;">
            <label style="display: flex; align-items: center; gap: 10px; cursor: pointer;">
                <?= $this->Form->checkbox('is_available') ?>
        ...
        <div style="margin-top: 30px; display: flex; justify-content: space-between; align-items: center;">
            <?= $this->Form->postLink(
                ...
                ['confirm' => __('Are you sure you want to delete this schedule slot?'), 'class' => 'btn btn-danger']
            ) ?>
